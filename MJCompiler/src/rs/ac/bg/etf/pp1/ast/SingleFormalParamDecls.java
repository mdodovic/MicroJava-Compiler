...
public class SingleFormalParamDecls extends FormalParamList {

    private FormalParamDecl FormalParamDecl;

    public SingleFormalParamDecls (FormalParamDecl FormalParamDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SingleFormalParamDecls(\n");
